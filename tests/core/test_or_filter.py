...
class TestORFilterComposition:
    """Tests for filter_mode='or' in MosaicClient.query()."""
    ...
    def test_and_filter_default(self, client: MosaicClient) -> None:
    ...
    def test_or_filter_matches_either(self, client: MosaicClient) -> None:
    ...
    def test_or_filter_no_match(self, client: MosaicClient) -> None:
    ...
    def test_or_filter_single_filter(self, client: MosaicClient) -> None:
    ...
    def test_empty_filters_returns_all(self, client: MosaicClient) -> None:
