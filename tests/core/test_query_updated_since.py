...
Verifies that ``HippoClient.query_updated_since`` returns only entities
...
def _create(client: HippoClient, name: str) -> str:
...
class TestQueryUpdatedSince:
    ...
    def test_watermark_is_exclusive(self, client: HippoClient) -> None:
    ...
    def test_update_moves_entity_into_window(self, client: HippoClient) -> None:
    ...
    def test_filters_compose_with_watermark(self, client: HippoClient) -> None:
    ...
    def test_naive_watermark_treated_as_utc(self, client: HippoClient) -> None:
