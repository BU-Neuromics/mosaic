...
## Acceptance Criteria
- Given a user runs 'hippo --help', when they see the command list, then all commands including init, serve, migrate, validate, ingest, reference install/update/list, and compile-schema are properly displayed in the help output
...
- Given a user runs 'hippo --help', when they see the command list, then the help output includes proper descriptions for each command including init, serve, migrate, validate, ingest, reference install/update/list, and compile-schema
