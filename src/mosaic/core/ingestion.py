...
class IngestionPipeline:
    ...
    .. deprecated::
        Use ``mosaic.core.loaders.IngestPipeline`` together with a concrete
    ...
    def __init__(
        ...
        Args:
            client: MosaicClient instance for data operations.
    ...
    def process_source(self, source_config, client):
        ...
        Args:
            ...
            client: MosaicClient for database operations
