...
sec11 §11.6.2 / Doc 2 §3, §7. Mosaic has no bundle concept today; this is
...
:class:`~mosaic.core.loaders.schema_package.SchemaPackage`\\ s benefits from
...
class Bundle:
    ...
    def from_manifest(cls, source: str | Path | dict[str, Any]) -> "Bundle":
        ...
        Raises :class:`~mosaic.core.exceptions.ConfigError` with a clear
    ...
    def to_requires(self) -> dict[str, str]:
        ...
        matching mosaic's ``requires: { <loader>: "==x.y.z" }`` pin gate
