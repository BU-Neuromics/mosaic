"""Relationship management for Mosaic entities."""
...
class RelationshipExistsError(MosaicError):
...
class RelationshipNotFoundError(MosaicError):
...
class RelationshipManager:
    ...
    between entities in the Mosaic Metadata Tracking Service.
    """
