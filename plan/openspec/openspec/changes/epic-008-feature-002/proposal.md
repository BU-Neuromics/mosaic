# FTS5 Search Query and ScoredMatch Results

## Goal
FTS5 Search Query and ScoredMatch Results: Implement the EntityStore.search() method for the SQLite adapter using FTS5 ranked queries. Returns list[ScoredMatch] ordered by relevance score descending.
...
## Constraints
- Depends on: epic-008-feature-001, epic-004-feature-001
- Complexity: medium
